...
goog.require('lt.object');
goog.require('lt.object');
lt.objs.langs.ruby.config.__BEH__ruby_exe = (function __BEH__ruby_exe(this$,exe){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby.client","ruby-exe","lt.objs.langs.ruby.client/ruby-exe",1352032473),exe], null));
});
...
lt.objs.langs.ruby.config.__BEH__use_rvm = (function __BEH__use_rvm(this$){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby.client","use-rvm?","lt.objs.langs.ruby.client/use-rvm?",4756059398),true], null));
});
...
lt.objs.langs.ruby.config.__BEH__rvm_path = (function __BEH__rvm_path(this$,path){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby.client","rvm-path","lt.objs.langs.ruby.client/rvm-path",2419157655),path], null));
});
...
lt.objs.langs.ruby.config.__BEH__use_rbenv = (function __BEH__use_rbenv(this$){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby.client","use-rbenv?","lt.objs.langs.ruby.client/use-rbenv?",1607909234),true], null));
});
...
lt.objs.langs.ruby.config.__BEH__client_enable_logging = (function __BEH__client_enable_logging(this$){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby.client","enable-client-logging?","lt.objs.langs.ruby.client/enable-client-logging?",2963145218),true], null));
});
...
lt.objs.langs.ruby.client.run_rb = (function run_rb(p__8195){var map__8197 = p__8195;var map__8197__$1 = ((cljs.core.seq_QMARK_.call(null,map__8197))?cljs.core.apply.call(null,cljs.core.hash_map,map__8197):map__8197);var info = map__8197__$1;var client = cljs.core.get.call(null,map__8197__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__8197__$1,new cljs.core.Keyword(null,"name","name",1017277949));var project_path = cljs.core.get.call(null,map__8197__$1,new cljs.core.Keyword(null,"project-path","project-path",1907176907));var path = cljs.core.get.call(null,map__8197__$1,new cljs.core.Keyword(null,"path","path",1017337751));var n = lt.objs.notifos.working.call(null,"Connecting..");var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.objs.langs.ruby.client","connecting-notifier","lt.objs.langs.ruby.client/connecting-notifier",584460901),client);var use_runner = (function (){var or__6755__auto__ = new cljs.core.Keyword("lt.objs.langs.ruby.client","use-rvm?","lt.objs.langs.ruby.client/use-rvm?",4756059398).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.langs.ruby.client.ruby));if(cljs.core.truth_(or__6755__auto__))
{return or__6755__auto__;
} else
...
goog.require('lt.objs.langs.ruby.client');
goog.require('lt.objs.langs.ruby.watch');
goog.require('lt.objs.langs.ruby.image');
goog.require('lt.objs.langs.ruby.watch');
goog.require('lt.objs.langs.ruby.live');
goog.require('lt.objs.langs.ruby.config');
goog.require('lt.objs.langs.ruby.config');
goog.require('lt.objs.langs.ruby.eval');
goog.require('lt.objs.langs.ruby.image');
goog.require('lt.object');
goog.require('lt.object');
goog.require('lt.objs.langs.ruby.live');
