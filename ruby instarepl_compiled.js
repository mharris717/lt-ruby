...
goog.require('lt.objs.clients');
goog.require('lt.objs.editor');
lt.objs.langs.ruby.eval.__BEH__on_eval = (function __BEH__on_eval(editor){return lt.object.raise.call(null,lt.objs.langs.ruby.eval.ruby,new cljs.core.Keyword(null,"eval!","eval!",1110791799),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"info","info",1017141280),cljs.core.assoc.call(null,cljs.core.deref.call(null,editor).call(null,new cljs.core.Keyword(null,"info","info",1017141280)),new cljs.core.Keyword(null,"code","code",1016963423),lt.plugins.watches.watched_range.call(null,editor,null,null,lt.objs.langs.ruby.eval.ruby_watch),new cljs.core.Keyword(null,"meta","meta",1017252215),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"start","start",1123661780),0,new cljs.core.Keyword(null,"end","end",1014004813),lt.objs.editor.last_line.call(null,editor)], null))], null));
});
...
lt.objs.langs.ruby.eval.__BEH__eval_BANG_ = (function __BEH__eval_BANG_(this$,event){var map__8556 = event;var map__8556__$1 = ((cljs.core.seq_QMARK_.call(null,map__8556))?cljs.core.apply.call(null,cljs.core.hash_map,map__8556):map__8556);var origin = cljs.core.get.call(null,map__8556__$1,new cljs.core.Keyword(null,"origin","origin",4300251800));var info = cljs.core.get.call(null,map__8556__$1,new cljs.core.Keyword(null,"info","info",1017141280));var client = new cljs.core.Keyword(null,"default","default",2558708147).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"client","client",3951159101).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,origin)));lt.objs.notifos.working.call(null,"");
return lt.objs.clients.send.call(null,lt.objs.eval.get_client_BANG_.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"command","command",1964298941),new cljs.core.Keyword(null,"editor.eval.ruby","editor.eval.ruby",3156763677),new cljs.core.Keyword(null,"origin","origin",4300251800),origin,new cljs.core.Keyword(null,"info","info",1017141280),info,new cljs.core.Keyword(null,"create","create",3956577390),lt.objs.langs.ruby.eval.try_connect], null)),new cljs.core.Keyword(null,"editor.eval.ruby","editor.eval.ruby",3156763677),info,new cljs.core.Keyword(null,"only","only",1017320222),origin);
});
...
goog.require('lt.object');
goog.require('lt.object');
lt.objs.langs.ruby.config.__BEH__ruby_exe = (function __BEH__ruby_exe(this$,exe){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby","ruby-exe","lt.objs.langs.ruby/ruby-exe",1735754269),exe], null));
});
...
lt.objs.langs.ruby.config.__BEH__use_rvm = (function __BEH__use_rvm(this$){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby","use-rvm?","lt.objs.langs.ruby/use-rvm?",3656895808),true], null));
});
...
lt.objs.langs.ruby.config.__BEH__rvm_path = (function __BEH__rvm_path(this$,path){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby","rvm-path","lt.objs.langs.ruby/rvm-path",1422692051),path], null));
});
...
lt.objs.langs.ruby.config.__BEH__use_rbenv = (function __BEH__use_rbenv(this$){return lt.object.merge_BANG_.call(null,lt.objs.langs.ruby.config.ruby,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("lt.objs.langs.ruby","use-rbenv?","lt.objs.langs.ruby/use-rbenv?",615998644),true], null));
});
...
{var code_8460 = lt.objs.editor.line.call(null,editor,(new_lc - 1));var line_8461 = (new_lc - 1);var info_8462 = cljs.core.assoc.call(null,cljs.core.assoc.call(null,new cljs.core.Keyword(null,"info","info",1017141280).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,editor)),new cljs.core.Keyword(null,"code","code",1016963423),code_8460),new cljs.core.Keyword(null,"meta","meta",1017252215),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"start","start",1123661780),line_8461,new cljs.core.Keyword(null,"end","end",1014004813),line_8461], null));if((!(cljs.core.empty_QMARK_.call(null,code_8460))) && (cljs.core.not.call(null,/^\s*$/.test(code_8460))))
{lt.object.raise.call(null,lt.objs.langs.ruby.live.ruby,new cljs.core.Keyword(null,"eval!","eval!",1110791799),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"origin","origin",4300251800),editor,new cljs.core.Keyword(null,"info","info",1017141280),info_8462], null));
} else
{}
} else
{}
...
lt.objs.langs.ruby.live.live_toggler = (function live_toggler(this$){var e__8111__auto__ = crate.core.html.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#instarepl","div#instarepl",2561476298),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1017440956),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",1108647146),lt.objs.langs.ruby.live.bound.call(null,this$,(function (p1__8447_SHARP_){return [cljs.core.str("livetoggler "),cljs.core.str((cljs.core.truth_(new cljs.core.Keyword(null,"live","live",1017226334).cljs$core$IFn$_invoke$arity$1(p1__8447_SHARP_))?null:"off"))].join('');
}))], null),"live"], null)], null));var seq__8454_8463 = cljs.core.seq.call(null,cljs.core.partition.call(null,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"click","click",1108654330),(function (e){lt.util.dom.prevent.call(null,e);
...
})], null)));var chunk__8455_8464 = null;var count__8456_8465 = 0;var i__8457_8466 = 0;while(true){
if((i__8457_8466 < count__8456_8465))
{var vec__8458_8467 = cljs.core._nth.call(null,chunk__8455_8464,i__8457_8466);var ev__8112__auto___8468 = cljs.core.nth.call(null,vec__8458_8467,0,null);var func__8113__auto___8469 = cljs.core.nth.call(null,vec__8458_8467,1,null);lt.util.dom.on.call(null,e__8111__auto__,ev__8112__auto___8468,func__8113__auto___8469);
{
var G__8470 = seq__8454_8463;
var G__8471 = chunk__8455_8464;
var G__8472 = count__8456_8465;
var G__8473 = (i__8457_8466 + 1);
seq__8454_8463 = G__8470;
chunk__8455_8464 = G__8471;
count__8456_8465 = G__8472;
i__8457_8466 = G__8473;
continue;
}
} else
{var temp__4092__auto___8474 = cljs.core.seq.call(null,seq__8454_8463);if(temp__4092__auto___8474)
{var seq__8454_8475__$1 = temp__4092__auto___8474;if(cljs.core.chunked_seq_QMARK_.call(null,seq__8454_8475__$1))
{var c__7497__auto___8476 = cljs.core.chunk_first.call(null,seq__8454_8475__$1);{
var G__8477 = cljs.core.chunk_rest.call(null,seq__8454_8475__$1);
var G__8478 = c__7497__auto___8476;
var G__8479 = cljs.core.count.call(null,c__7497__auto___8476);
var G__8480 = 0;
seq__8454_8463 = G__8477;
chunk__8455_8464 = G__8478;
count__8456_8465 = G__8479;
i__8457_8466 = G__8480;
continue;
}
} else
{var vec__8459_8481 = cljs.core.first.call(null,seq__8454_8475__$1);var ev__8112__auto___8482 = cljs.core.nth.call(null,vec__8459_8481,0,null);var func__8113__auto___8483 = cljs.core.nth.call(null,vec__8459_8481,1,null);lt.util.dom.on.call(null,e__8111__auto__,ev__8112__auto___8482,func__8113__auto___8483);
{
var G__8484 = cljs.core.next.call(null,seq__8454_8475__$1);
var G__8485 = null;
var G__8486 = 0;
var G__8487 = 0;
seq__8454_8463 = G__8484;
chunk__8455_8464 = G__8485;
count__8456_8465 = G__8486;
i__8457_8466 = G__8487;
continue;
}
}
} else
...
goog.require('lt.objs.command');
goog.require('lt.objs.editor');
lt.objs.langs.ruby.client.plugin_dir = "/code/orig/lt-ruby";
...
lt.objs.langs.ruby.client.run_rb = (function run_rb(p__8429){var map__8431 = p__8429;var map__8431__$1 = ((cljs.core.seq_QMARK_.call(null,map__8431))?cljs.core.apply.call(null,cljs.core.hash_map,map__8431):map__8431);var info = map__8431__$1;var client = cljs.core.get.call(null,map__8431__$1,new cljs.core.Keyword(null,"client","client",3951159101));var name = cljs.core.get.call(null,map__8431__$1,new cljs.core.Keyword(null,"name","name",1017277949));var project_path = cljs.core.get.call(null,map__8431__$1,new cljs.core.Keyword(null,"project-path","project-path",1907176907));var path = cljs.core.get.call(null,map__8431__$1,new cljs.core.Keyword(null,"path","path",1017337751));var n = lt.objs.notifos.working.call(null,"Connecting..");var obj = lt.object.create.call(null,new cljs.core.Keyword("lt.objs.langs.ruby.client","connecting-notifier","lt.objs.langs.ruby.client/connecting-notifier",584460901),client);var use_runner = (function (){var or__6755__auto__ = new cljs.core.Keyword("lt.objs.langs.ruby.client","use-rvm?","lt.objs.langs.ruby.client/use-rvm?",4756059398).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.langs.ruby.client.ruby));if(cljs.core.truth_(or__6755__auto__))
{return or__6755__auto__;
} else
{return new cljs.core.Keyword("lt.objs.langs.ruby.client","use-rbenv?","lt.objs.langs.ruby.client/use-rbenv?",1607909234).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.langs.ruby.client.ruby));
}
})();var keys__GT_env = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("lt.objs.langs.ruby.client","use-rbenv?","lt.objs.langs.ruby.client/use-rbenv?",1607909234),new cljs.core.Keyword(null,"LT_USE_RBENV","LT_USE_RBENV",3640591680),new cljs.core.Keyword("lt.objs.langs.ruby.client","use-rvm?","lt.objs.langs.ruby.client/use-rvm?",4756059398),new cljs.core.Keyword(null,"LT_USE_RVM","LT_USE_RVM",4685907820),new cljs.core.Keyword("lt.objs.langs.ruby.client","enable-client-logging?","lt.objs.langs.ruby.client/enable-client-logging?",2963145218),new cljs.core.Keyword(null,"LT_ENABLE_CLIENT_LOGGING","LT_ENABLE_CLIENT_LOGGING",1714721026)], null);var env = cljs.core.zipmap.call(null,cljs.core.map.call(null,keys__GT_env,cljs.core.keys.call(null,cljs.core.select_keys.call(null,cljs.core.deref.call(null,lt.objs.langs.ruby.client.ruby),cljs.core.keys.call(null,keys__GT_env)))),cljs.core.cycle.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [true], null)));var env__$1 = (cljs.core.truth_(new cljs.core.Keyword("lt.objs.langs.ruby.client","rvm-path","lt.objs.langs.ruby.client/rvm-path",2419157655).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.langs.ruby.client.ruby)))?cljs.core.assoc.call(null,env,new cljs.core.Keyword(null,"LT_RVM_PATH","LT_RVM_PATH",839899236),new cljs.core.Keyword("lt.objs.langs.ruby.client","rvm-path","lt.objs.langs.ruby.client/rvm-path",2419157655).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.langs.ruby.client.ruby))):env);var command = (cljs.core.truth_(use_runner)?"bash":(function (){var or__6755__auto__ = new cljs.core.Keyword("lt.objs.langs.ruby.client","ruby-exe","lt.objs.langs.ruby.client/ruby-exe",1352032473).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lt.objs.langs.ruby.client.ruby));if(cljs.core.truth_(or__6755__auto__))
{return or__6755__auto__;
} else
{return "ruby";
}
...
{{
var G__8444 = lt.objs.files.parent.call(null,cur);
var G__8445 = cur;
cur = G__8444;
prev = G__8445;
continue;
...
lt.objs.langs.ruby.client.notify = (function notify(obj){var map__8433 = obj;var map__8433__$1 = ((cljs.core.seq_QMARK_.call(null,map__8433))?cljs.core.apply.call(null,cljs.core.hash_map,map__8433):map__8433);var client = cljs.core.get.call(null,map__8433__$1,new cljs.core.Keyword(null,"client","client",3951159101));var ruby_client = cljs.core.get.call(null,map__8433__$1,new cljs.core.Keyword(null,"ruby-client","ruby-client",4412625552));var path = cljs.core.get.call(null,map__8433__$1,new cljs.core.Keyword(null,"path","path",1017337751));var project_path = cljs.core.get.call(null,map__8433__$1,new cljs.core.Keyword(null,"project-path","project-path",1907176907));var ruby = cljs.core.get.call(null,map__8433__$1,new cljs.core.Keyword(null,"ruby","ruby",1017416012));if((cljs.core.not.call(null,ruby)) || (cljs.core.empty_QMARK_.call(null,ruby)))
...
goog.require('lt.objs.command');
goog.require('lt.objs.editor');
lt.objs.langs.ruby.try_connect = (function try_connect(p__8488){var map__8490 = p__8488;var map__8490__$1 = ((cljs.core.seq_QMARK_.call(null,map__8490))?cljs.core.apply.call(null,cljs.core.hash_map,map__8490):map__8490);var info = cljs.core.get.call(null,map__8490__$1,new cljs.core.Keyword(null,"info","info",1017141280));var path = new cljs.core.Keyword(null,"path","path",1017337751).cljs$core$IFn$_invoke$arity$1(info);var client = lt.objs.clients.client_BANG_.call(null,new cljs.core.Keyword(null,"ruby.client","ruby.client",1005161937));lt.objs.langs.ruby.check_all.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",1017337751),path,new cljs.core.Keyword(null,"client","client",3951159101),client], null));
return client;
});
...
.defui.call(null,.image,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [.src], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"img","img",1014008629),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"src","src",1014018390),[cljs.core.str("data:image/png;base64,"),cljs.core.str(.src)].join('')], null)], null));
.defui.call(null,.canvas,cljs.core.PersistentVector.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"canvas","canvas",3941165258)], null));
.behavior.call(null,new cljs.core.Keyword("cljs.user","ruby-image","cljs.user/ruby-image",2627349326),new cljs.core.Keyword(null,"triggers","triggers",2516997421),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"editor.eval.ruby.image","editor.eval.ruby.image",2979499466),null], null), null),new cljs.core.Keyword(null,"reaction","reaction",4441361819),(function (editor,img){return object.raise.call(null,editor,new cljs.core.Keyword(null,"editor.result.underline","editor.result.underline",541343758),.image.call(null,new cljs.core.Keyword(null,"image","image",1114217677).cljs$core$IFn$_invoke$arity$1(img)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"line","line",1017226086),new cljs.core.Keyword(null,"end","end",1014004813).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"meta","meta",1017252215).cljs$core$IFn$_invoke$arity$1(img)),new cljs.core.Keyword(null,"start-line","start-line",3689311729),new cljs.core.Keyword(null,"start","start",1123661780).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"meta","meta",1017252215).cljs$core$IFn$_invoke$arity$1(img))], null));
}));
}
